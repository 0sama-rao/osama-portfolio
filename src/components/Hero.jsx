...
const Hero = (mainData) => {
  ...
  const { name, titles, shortDesc, techStackImages } = mainData.data;
  ...
  return (
    ...
    >
      <div className="absolute -z-10 min-h-screen h-full w-full">
        <img
          src={bgImage}
          effect="blur" // You can use 'opacity', 'black-and-white', 'sepia', 'blur', or leave it empty
          threshold={100}
          width="100%" // Set the desired width of the image
          height="500px" // Set the desired height of the image
          alt={""}
        />
      </div>
      ...
      <div className="py-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
        <div className="flex flex-col gap-4 md:gap-6 text-left lg:w-1/2 2xl:w-1/3 mx-4 md:mx-6 xl:mx-0">
          ...
          <dev className="flex flex-row gap-4">
            <ScrollLink
